...
public class ConsolaOlimpicos
{
	...
	public void ejecutarAplicacion()
	{
		...
		while (continuar)
		{
			try
			{
				...
				{
					ejecutarEncontrarPaisDeJugador();
				}
	...
	public void mostrarMenu()
	{
		...
		System.out.println("14. Consultar el pais que un atleta representa\n");
	}
	...
	private void ejecutarEncontrarPaisDeJugador()
	{
		System.out.println("\n" + "Pais que un jugador representa" + "\n");

		String atleta = input("Por favor ingrese el nombre del atleta: ");
		String pais = calculadora.paisDeAtleta(atleta);
		
		if (pais == null) {
			System.out.println("El/La atleta " + atleta + " no se ha encontrado."); 
		} else {
			System.out.println(atleta + " representa el pais de " + pais); 
		}
	}
